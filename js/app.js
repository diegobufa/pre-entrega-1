...
const gastoMayor = () =>{
     ...
     const gastoMayorMes= prompt("Quieres ver los gastos de tu mes? si o no").toLowerCase();
     
     if (gastoMayorMes === "no"){
         alert("no hay datos");
     }else if (gastoMayorMes  === "si") {
         let gastoMes = [];
         for (let mesGasto of misGastos){
             gastoMes.push(mesGasto.getGasto());
         }
        console.log(gastoMes.sort()[1]);
     }
     else {
         alert ("Faltan datos");
     }
